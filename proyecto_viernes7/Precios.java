...
public class Precios
{
    ...
    public static void main(String[] args) throws Exception{
        ...
        int opcionMenu = 0, valorTotal = 0;
        
        do{
            System.out.println("\nMenu de Opciones");
            System.out.println("1. Adicionar zapatos de cuero");
            System.out.println("2. Adicionar zapatos sinteticos");
            System.out.println("3. Adicionar zapatos de caucho");
            ...
            switch (opcionMenu){
                ...
                case 2:
                    ...
                    for(int i = 0; i < numZapatos2; i++){
                        ...
                        costos = sc.nextInt();
                        agregarTalla(num);
                        miZapate.adicionarZapa(numZapatos2, materiall2, num, costos);
                    }
                break;
                case 3:
                    System.out.println("Digite el numero de pares de zapatos comprados: ");
                    ...
                    for(int i = 0; i < numZapatos3; i++){
                        ...
                        costos = sc.nextInt();
                        agregarTalla(num);
                        miZapate.adicionarZapa(numZapatos3, num, materiall3, costos);
                    }
                break;
                case 4:
